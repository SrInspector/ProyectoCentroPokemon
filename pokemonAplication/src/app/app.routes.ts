...
export const routes: Routes = [
  {
    path: 'comprobantes',
    loadComponent: () => import('./pages/comprobantes/comprobantes.page').then(m => m.ComprobantesPage),
  ...
  {
    path: 'estado-clinico',
    loadComponent: () => import('./pages/estado-clinico/estado-clinico.page').then(m => m.EstadoClinicoPage),
    canActivate: [authGuard]
  },
  {
    path: 'comprobantes',
